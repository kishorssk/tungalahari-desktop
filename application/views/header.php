...
<head>
    ...
    –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    <meta charset="utf-8">
    <title><?php if($pageTitle) echo $pageTitle . ' | '; ?>Tungalahari, Sharada Peetham, Sringeri</title>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:100,200,300,400italic,400,600,700' rel='stylesheet' type='text/css'>
    ...
    <script type="text/javascript">var base_url = "<?= BASE_URL?>"; var avatar_url = "<?= AVATAR_IMAGE_URL?>";</script>
    <!-- Favicon
    –––––––––––––––––––––––––––––––––––––––––––––––––– -->
        ...
        <!-- Brand and toggle get grouped for better mobile display -->
            ...
            <div class="collapse navbar-collapse" id="navbar-primary-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="<?=BASE_URL?>"><img src="<?=PUBLIC_URL?>images/logo.png" alt="Logo of the Indian Academy of Sciences" class="img-circle logo"></a>
<!--
                        <span class="heading">Tungalahari</span>
-->
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
